...
{
	// Empires Ignited: pass the entity's owner so the panel shows the unit's
	// *current* (tech-modified) stats — damage, armour, and attack bonuses
	// (e.g. "×4 vs Structure" after a forge upgrade) — instead of base values.
